      ...
      <div className="page-title-box">
        <div>
          ...
          <div className="breadcrumb">
            <span>Dashboard</span> /{" "}
            <span className="current">Live Tallies</span>
          </div>
        </div>
      </div>
              ...
              {data.leaderboard.map((party, idx) => (
                <tr key={party.party_id}>
                  ...
                  <td>
                    ...
                    <span className="muted">({party.party_code})</span>
                  </td>
                  <td>
                    {party.party_icon_url && !imageErrors[party.party_id] ? (
                      <img
                        src={party.party_icon_url}
                        alt=""
                        className="avatar-sm"
                        onError={() => handleImageError(party.party_id)}
                      />
                    ) : (
                  ...
                  <td>
                    <strong>
                      {party.total_popular_votes.toLocaleString()}
                    </strong>
                  </td>
                  <td>
                    <button
          ...
          >
            ...
            <div className="modal-body">
              <p style={{ marginBottom: 14, fontWeight: 600 }}>
                Seats won: {selectedParty.seats_won}
              </p>
